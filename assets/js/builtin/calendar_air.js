...
// 出発の文言
var departure_name = "出発日を選択してください";
// 現地発の文言
var arrival_name = "現地出発日を選択してください";
// 出発のバルーン文言
var name_in = "出発日";
// 現地発のバルーン文言
var name_out = "現地発";
...
function click_cell(idx){
    if(start_end_flg[clicked_calendarbtn_index]){
        init();
        $('.calendar_cell').eq(idx).css({color:'#FFF',backgroundImage:'url('+web_r_url+'images/select_start.png)',backgroundSize:'100% 100%'});
        ...
        if(idx != saved_start[clicked_calendarbtn_index]){
            $('.calendar_cell').eq(idx).css({color:'#FFF',backgroundImage:'url('+web_r_url+'images/select_end.png)',backgroundSize:'100% 100%'});
...
function cell_to_gray(num){
    ...
    if(num>0){
        $('.calendar_cell').eq(saved_start[clicked_calendarbtn_index]).css({color:'#FFF',backgroundImage:'url('+web_r_url+'images/select_start.png)',backgroundSize:'100% 100%'});
        $('.calendar_cell').eq(saved_end[clicked_calendarbtn_index]).css({color:'#FFF',backgroundImage:'url('+web_r_url+'images/select_end.png)',backgroundSize:'100% 100%'});
...
$(window).load(function(){
    ...
    var calendar_html = first_loading();
...
//	$(document).on('click','.flight-calendar',function(){
